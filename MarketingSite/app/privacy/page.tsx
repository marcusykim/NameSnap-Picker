  ...
  return (
    <main className="public-page"><SiteHeader />
      ...
      <div className="public-summary shell">
        ...
        <time dateTime="2026-09-20">Effective September 20, 2026</time>
      </div>
      <article className="policy policy-grid shell">
        ...
        <section><h2>Web session and purchase data</h2><p>NameSnap Web stores one strictly necessary, randomly generated browser identifier in local browser storage. Free use does not require an account. To buy, enter a purchase email and continue to Stripe checkout; an email sign-in link is not required. Your browser remembers the purchase email for checkout and recovery. To restore a purchase on another browser, Firebase Authentication sends a passwordless sign-in link to verify ownership of that email. Cloudflare stores one-way hashes of the browser identifier, purchase email, and Firebase user identifier when available, together with the selected plan, entitlement status, checkout recovery records, and Stripe customer, checkout session, or subscription identifiers. This lets NameSnap confirm payment, prevent duplicate checkout, and restore a purchase without storing your contestant list. Stripe receives the purchase email and processes billing details and payment information under Stripe’s privacy policy. NameSnap does not receive your full payment-card number.</p></section>
        ...
        <section><h2>Service providers and data sharing</h2><p>Firebase provides website hosting and passwordless email verification for purchase recovery. Cloudflare provides the payment service endpoint and stores the web purchase records described above. Stripe processes web purchases. Apple processes in-app purchases. NameSnap does not sell or rent personal data and does not share it with advertisers or data brokers.</p></section>
        ...
        <section><h2>Contact</h2><p>Questions about this policy can be sent to <a aria-label="Email NameSnap about the privacy policy" href="mailto:sidequest@ik.me?subject=NameSnap%20Privacy">sidequest@ik.me</a>.</p></section>
      </article>
      <SiteFooter />
    </main>
  );
